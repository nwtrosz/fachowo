    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 pt-32 pb-20">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="font-display text-4xl md:text-5xl font-bold text-primary mb-8">Polityka Prywatności</h1>
          <div className="prose prose-slate max-w-none space-y-6 text-foreground/80 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-primary mb-4">3. Gromadzone dane</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-primary mb-4">4. Cel przetwarzania danych</h2>
...
export function TermsOfService() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 pt-32 pb-20">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="font-display text-4xl md:text-5xl font-bold text-primary mb-8">Warunki Usługi</h1>
          <div className="prose prose-slate max-w-none space-y-6 text-foreground/80 leading-relaxed">
            <p className="font-bold">Ostatnia aktualizacja: 26.02.2026</p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-primary mb-4">2. Usługi</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-primary mb-4">3. Wyceny</h2>
