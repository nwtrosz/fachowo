        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <p>Każdy użytkownik ma prawo do wglądu w swoje dane, ich poprawiania, usunięcia lub ograniczenia przetwarzania. W tym celu prosimy o kontakt pod adresem: fachowo.eu@gmail.com.</p>
            </section>
          </div>
        </div>
      </main>
